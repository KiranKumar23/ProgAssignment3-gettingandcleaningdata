...
filename <- "C:/H116501/Learningmaterials/R/3.GettingData/getdata_dataset.zip"
setwd('C:/H116501/Learningmaterials/R/3.GettingData')
...
if (!file.exists("UCIHARDataset")) { 
  unzip("C:/H116501/Learningmaterials/R/3.GettingData/getdata_dataset.zip") 
}
getwd()
...
# Load the datasets
train <- read.table("UCIHARDataset/train/X_train.txt")[featuresWanted]
...
test <- read.table("UCIHARDataset/test/X_test.txt")[featuresWanted]
